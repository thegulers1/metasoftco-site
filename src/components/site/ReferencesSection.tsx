...
const references = [
    ...
    "DYNAVİT", "AKBANK", "ECZACIBAŞI", "B/S/H/",
    "RIJK ZWAAN", "TAVUK DÜNYASI", "ESPRESSOLAB", "DEFACTO",
    "PEGASUS", "MG", "DR.JART+", "STRADESCO",
    "LC WAİKİKİ", "PERSİL", "ANADOLU HAYAT EMEKLİLİK", "SCHWARZKOPF",
];
