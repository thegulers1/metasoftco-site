...
const en = {
	...
	nav: {
		...
		items: [
			{ href: enPaths.routes.home, label: "Home" },
	...
	insightDetail: {
		...
		relatedServicesLink: "View service",
...
const tr: Phase2Copy = {
	...
	nav: {
		...
		items: [
			{ href: trPaths.routes.home, label: "Anasayfa" },
	...
	insightDetail: {
		...
		relatedServicesTitle: "Önerilen Hizmetler",
		relatedServicesLink: "Hizmeti İncele",
	...
	capabilityCategory: {
		...
		aboutTitle: "Bu kategori hakkında",
