...
const tr: Phase2Copy = {
    ...
    home: {
        ...
        heroFigureCaption: "Ray-Ban · Strip Photo",
        heroBrief: "MetasoftCo; markalar ve ajanslar için fotoğraf, video, oyun ve özel kurulumlardan oluşan markalı deneyimler tasarlar ve üretir. Yaratıcı fikirden özel yazılıma, fiziksel üretimden saha operasyonuna kadar tüm süreci tek ekipte buluştururuz.",
        ...
        workTitle: "İnsanları\n{deneyimin}\nparçası yapan\nprojeler.",
        workCopy: "Gerçek insanlar, gerçek anlar. Katılımcıyı izleyiciden deneyimin parçasına dönüştüren ve markayla kalıcı bağ kuran işler tasarlıyoruz.",
        ...
        process: [
            { number: "01", title: "İhtiyacı netleştiririz", copy: "Hedef kitleyi, mekânı, kampanya fikrini ve hedeflenen katılımcı yolculuğunu birlikte tanımlarız." },
            { number: "02", title: "Deneyimi tasarlarız", copy: "Yaratıcı yaklaşımı, etkileşim akışını ve teknik uygulanabilirliği netleştiririz." },
            { number: "03", title: "Sistemi geliştiririz", copy: "Özel yazılımı, markalı arayüzü, içeriği ve fiziksel bileşenleri tek sistemde birleştiririz." },
            { number: "04", title: "Sahada hayata geçiririz", copy: "Kurulumdan etkinlik günü operasyonuna kadar tüm süreci sahada yönetiriz." },
        ],
        ...
        finalCopy: "Hedef kitlenizi, mekânı ve kampanya hedefinizi paylaşın. Etkileşimi, teknolojiyi ve saha uygulamasını projenize göre birlikte kurgulayalım.",
    ...
    about: {
        ...
        heroCopy: "Yaratıcı fikir, özel yazılım, fiziksel üretim ve saha operasyonunu bir araya getirerek markaları insanlarla gerçek zamanlı buluşturan deneyimler tasarlıyor ve hayata geçiriyoruz.",
        ...
        principles: [
            { title: "Katılımı merkeze alırız", copy: "Yalnızca izlenen değil, insanların gerçekten dahil olduğu deneyimler tasarlarız." },
            { title: "Saha koşullarına hazırlarız", copy: "Her detayı etkinlik günü güvenilir ve sorunsuz çalışacak şekilde planlarız." },
    ...
    contact: {
        ...
        form: {
            ...
            experienceTypes: ["Yapay Zekâ Fotoğraf ve Video", "Fotoğraf Aktivasyonları", "İnteraktif Oyunlar", "Özel Kurulumlar"],
            brief: "Projenizi anlatın *",
            briefPlaceholder: "Hedefinizi, katılımcı kitlenizi, vermek istediğiniz mesajı ve varsa örnek aldığınız işleri paylaşın…",
        ...
        nextSteps: [
            { number: "01", title: "İhtiyacı anlarız", copy: "Proje detaylarınızı inceler, hedefi netleştirmek için doğru soruları sorarız." },
            { number: "02", title: "Deneyimi kurgularız", copy: "Markanıza ve hedef kitlenize uygun deneyimi ve teknik çözümü tasarlarız." },
            { number: "03", title: "Sahaya hazırlarız", copy: "Ekibi, üretimi ve takvimi planlar; deneyimi etkinlik gününe hazır hâle getiririz." },
        ],
    ...
    work: {
        ...
        heroCopy: "İnsanları izleyici olmaktan çıkarıp deneyimin parçasına dönüştüren, markayla gerçek bağ kuran aktivasyonlar tasarlıyor ve sahada hayata geçiriyoruz.",
    ...
    capabilities: {
        ...
        heroCopy: "Yaratıcı fikir, özel yazılım, fiziksel üretim ve saha operasyonunu bir araya getirerek markaları insanlarla buluşturan deneyimleri uçtan uca geliştiriyoruz.",
        catalogAria: "Hizmetler",
        cardLink: "Hizmeti İncele",
        endToEndTitle: "Tek ekip,\nuçtan uca çözüm",
        process: [
            { number: "01", title: "Keşif", copy: "İhtiyacı dinler; hedefi, katılımcı kitlesini ve başarı ölçütlerini birlikte netleştiririz." },
            { number: "02", title: "Tasarım", copy: "Fikri, katılımcı yolculuğunu ve teknik çözümü bir bütün olarak tasarlarız." },
            { number: "03", title: "Geliştirme", copy: "Yazılımı, arayüzü ve fiziksel bileşenleri geliştirir, test eder ve bir araya getiririz." },
            { number: "04", title: "Saha", copy: "Kurulumu yapar, etkinlik günü operasyonunu yürütür ve deneyimin sorunsuz çalışmasını sağlarız." },
        ],
        ctaSolid: "Fikrinizi",
    ...
    workDetail: {
        ...
        heroSolid: "Ray-Ban ×",
        heroOutline: "Strip Photo",
        heroCopy: "Katılımcıların anlarını, paylaşmak ve saklamak isteyecekleri markalı fotoğraf şeritlerine dönüştüren bir fotoğraf aktivasyonu.",
        facts: [
        ...
        fallbackGalleryAlts: ["Strip Photo aktivasyonu", "Strip Photo deneyimini kullanan katılımcılar", "Basılmış fotoğraf şeridi"],
        briefTitle: "İhtiyaç",
        briefCopy: "Ray-Ban, ikonik stilini paylaşılabilir bir deneyimle buluşturan ve etkinlik bittikten sonra da katılımcıların yanında kalacak bir fotoğraf uygulaması istedi.",
        experienceTitle: "Deneyim",
        experienceCopy: "Katılımcı alana girer ve poz verir. Sistemimiz art arda çektiği karelerle anın enerjisini yakalar; ortaya anında basılan ve dijital olarak paylaşılabilen markalı bir fotoğraf şeridi çıkar.",
        systemTitle: "Sistem",
        system: [
            { title: "Çekim", copy: "Kamera sistemi art arda kareler yakalayarak doğal ifadeleri ve hareketi kaydeder." },
            { title: "Marka uygulaması", copy: "Ray-Ban’in marka öğeleri ve çerçeve tasarımları her fotoğraf şeridine anında uygulanır." },
            { title: "Baskı", copy: "Yüksek kaliteli fotoğraf şeritleri anında basılır ve katılımcılara kalıcı bir hatıra olarak verilir." },
            { title: "Paylaşım", copy: "Katılımcılar QR kodu okutarak dijital fotoğraf şeritlerine ulaşır ve diledikleri yerde paylaşır." },
        ],
        impact: [
    ...
    capabilityDetail: {
        ...
        formats: [
            { title: "Yapay Zekâ Portre", copy: "Markanıza özel fonlar, görsel stiller ve tasarımlarla oluşturulan yapay zekâ destekli portreler." },
            ...
            { title: "Yapay Zekâ Arka Plan", copy: "Yapay zekâ ile üretilen arka planlarla katılımcıları istediğiniz görsel dünyaya taşıyın." },
            { title: "Yapay Zekâ Çizim", copy: "Basit çizimleri veya kısa metinleri, markanıza özel tamamlanmış görsellere dönüştürün." },
            { title: "Markalı Video", copy: "Markaya özel hareket, kurgu ve efektlerle hazırlanan yapay zekâ destekli kısa videolar." },
        ],
        ...
        flow: [
            ...
            { number: "03", title: "Marka uygulaması", copy: "Kampanyaya özel logo, grafik ve tasarım öğeleri sonuca uygulanır." },
            { number: "04", title: "Kontrol", copy: "Saha ekibi sonucu anında kontrol eder ve onaylar." },
            { number: "05", title: "Teslim", copy: "Sonuç yüksek çözünürlükte dijital olarak paylaşılır, basılır veya kaydedilir." },
        ],
        ...
        guarantees: [
            { title: "Hızlı sonuç", copy: "Optimize edilmiş yapay zekâ işleme altyapısı, saniyeler içinde yüksek kaliteli içerik üretir." },
            { title: "Marka bütünlüğü", copy: "Önceden belirlenen görsel kurallar, her çıktının marka kimliğiyle uyumlu kalmasını sağlar." },
            { title: "Saha operasyonu", copy: "Donanım, yazılım ve ekip akışı; etkinlik ortamında kesintisiz çalışacak şekilde planlanır." },
            { title: "Veri güvenliği ve açık rıza", copy: "Güvenli saklama, katılımcı onay akışları ve KVKK’ya uygun veri yönetimi." },
        ],
        selectedTitle: "Seçili yapay zekâ fotoğraf projeleri",
        selected: [
            { slug: "defacto-x-afra-saracoglu-ai-fashion-experience", title: "DeFacto × Afra Saraçoğlu", alt: "DeFacto yapay zekâ moda deneyimi", image: "https://res.cloudinary.com/dqkehdebg/image/upload/v1776151672/metasoftco/projects/s2tx0odiouo33iv3evpz.png" },
            { slug: "adidas-evo-sl-x-ai-try-on-photo", title: "Adidas EVO SL × AI Try-On", alt: "Adidas yapay zekâ sanal deneme", image: "https://res.cloudinary.com/dqkehdebg/image/upload/v1774878244/metasoftco/projects/zm4fhoverbifgnm2agsj.png" },
            { slug: "tavuk-dunyasi-x-ai-photo", title: "Tavuk Dünyası × AI Photo", alt: "Tavuk Dünyası AI Photo", image: "https://res.cloudinary.com/dqkehdebg/image/upload/v1784029645/metasoftco/projects/w3ixfgdzqbywnyv12ddg.png" },
        ],
    ...
    caseStudy: {
        ...
        opportunityLede: "Her katılımcıyı Tavuk Dünyası için tasarlanan görsel dünyanın merkezine yerleştirdik. Yaratıcı fikirden çekim akışına ve son görseldeki marka uygulamasına kadar tüm adımları tek bir katılımcı deneyimi olarak kurguladık.",
        opportunityCopy: "Katılımcılar içeriği yalnızca izlemek yerine kendi portreleriyle içeriğin bir parçası oldu. Böylece kampanyayla doğrudan, kişisel ve akılda kalıcı bir etkileşim kuruldu.",
        conceptEyebrow: "YARATICI FİKİR",
        conceptTitle: "Katılımcıyla tamamlanan markalı bir görsel dünya.",
        conceptCopy: "Görsel dünya, marka kimliğini korurken her katılımcının doğal biçimde odak noktasına yerleşebileceği şekilde tasarlandı.",
        journey: [
            { number: "01", title: "Katılımcı portresi", copy: "Katılımcının portresi markaya özel çekim alanında alınır." },
            { number: "02", title: "Markalı sahne", copy: "Portre, Tavuk Dünyası için tasarlanan görsel dünyaya yerleştirilir." },
            { number: "03", title: "Yapay zekâ dönüşümü", copy: "Görüntü işleme altyapısı kişiselleştirilmiş son görseli saniyeler içinde oluşturur." },
            { number: "04", title: "Dijital hatıra", copy: "Katılımcı markalı sonucu dijital ve paylaşılabilir bir görsel olarak alır." },
        ],
        executionEyebrow: "FİZİKSEL UYGULAMA",
        executionTitle: "Ekrandaki etkileşimden kişisel bir hatıraya.",
        executionCopy: "Deneyim; markalı bir kiosk, kolay anlaşılır bir katılımcı akışı ve sonunda teslim edilen kişiselleştirilmiş yapay zekâ görselinden oluşan fiziksel bir etkinlik kurulumu olarak hayata geçirildi.",
        executionChecklist: [
        ...
        finalCopy: "Katılımcı kitlenizi, mekânı ve görsel fikrinizi paylaşın. Biz de bunları sahada sorunsuz çalışan, markanıza özel bir deneyime dönüştürelim.",
