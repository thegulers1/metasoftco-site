                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 pr-12 bg-[#f5f5f5] border-0 rounded-lg text-black placeholder:text-black/40 focus:outline-none focus:ring-2 focus:ring-black"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowPassword(!showPassword)}
                                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-black/50 hover:text-black transition"
